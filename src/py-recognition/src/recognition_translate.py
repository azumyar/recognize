...
try:
    ...
    # kotoba_whisper 2.1から移植
    def _fix_timestamp(sample_rate: int, result: List[Dict[str, Any]], audio: np.ndarray) -> stable_whisper.WhisperResult:
        ...
        return stable_whisper.WhisperResult([words], force_order=True, check_sorted=True)
